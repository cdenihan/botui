...
abstract class ExpressionEffectsPainter {
  static void drawExpressionEffects(
    Canvas canvas,
    Size size,
    ...
    if (expression == RobotExpression.neutral || intensity <= 0.3) {
      return;
    }

    switch (expression) {
      case RobotExpression.happy:
        _SparkleEffects.draw(canvas, size, intensity, eyePaint, expressionSeed);
        break;
      case RobotExpression.excited:
        _EnergyLineEffects.draw(canvas, size, intensity, eyePaint, expressionSeed);
        break;
      case RobotExpression.love:
        _HeartEffects.draw(canvas, size, intensity, eyePaint, expressionSeed);
        break;
      case RobotExpression.dizzy:
        _DizzySwirlEffects.draw(canvas, size, intensity, eyePaint, expressionSeed);
        break;
      case RobotExpression.surprised:
        _ShockLineEffects.draw(canvas, size, intensity, eyePaint, expressionSeed);
        break;
      default:
        break;
    }
